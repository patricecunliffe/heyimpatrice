        ...
        <div className="grid lg:grid-cols-2 gap-2 items-center min-h-[70vh] md:min-h-[80vh]">
          ...
          <div className="text-left flex flex-col justify-center">
            ...
            <div className="mb-4 md:mb-8 opacity-0 animate-fade-in-delayed">
              <h1 className="text-5xl sm:text-4xl md:text-6xl leading-tight mb-6 lg:text-8xl">
                {displayText}
          ...
          <div className="hidden lg:flex justify-center opacity-0 animate-fade-in-delayed mt-4">
            <div className="w-96 h-96 lg:w-[500px] lg:h-[500px]">
              <img src="/lovable-uploads/patrice-cropped.png" alt="Patrice - Character illustration" className="w-full h-full object-contain dark:invert" />
            </div>
          </div>
        </div>
      </div>
