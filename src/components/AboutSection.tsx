...
I believe every business deserves a website that works as hard as they do. That’s why I specialize in creating clean, conversion-focused designs that cut through the digital noise and get straight to the point. No unnecessary bells and whistles – just smart, strategic web solutions that help people connect with their audience and grow their impact.                </p>
            ...
            <div className="flex justify-center lg:justify-end animate-fade-in">
              <div className="relative">
                <img src="https://raw.githubusercontent.com/patricecunliffe/spirit-gift-navigator/refs/heads/main/patrice%20(green-transparent).png?token=GHSAT0AAAAAADH5FWHVLDMHZW2M7YVHZ4RA2ENKLHA" alt="Pat Cunliffe - Patrice" className="w-[30rem] h-[30rem] lg:w-[35rem] lg:h-[35rem] object-cover rounded-full shadow-strong hover:shadow-intense transition-all duration-300 transform hover:scale-105 grayscale" />
                {/* Decorative element */}
