...
const ProcessSection = () => {
  return <section aria-labelledby="process-heading" className="pt-6 md:pt-8 pb-12 md:pb-16">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="md:hidden space-y-5">
          {steps.map((step, idx) => <article key={idx} className="flex items-start gap-4 animate-fade-in" style={{
        ...
        <div className="hidden md:flex items-start justify-between gap-6 lg:gap-8">
          {steps.map((step, idx) => <article key={idx} className="flex-1 min-w-0 text-center animate-fade-in" style={{
          animationDelay: `${idx * 0.06}s`
        }}>
              ...
              <h4 className="font-medium leading-tight max-w-[18rem] mx-auto text-2xl">{step.title}</h4>
