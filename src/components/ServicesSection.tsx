...
const ServicesSection = () => {
  ...
  const services = [{
    ...
    description: "Single landing page & links for social media with clear CTAs and quick deployment. Perfect for getting your business online fast.",
    icon: Rocket,
    ...
    details: {
      ...
      includes: ["Up to 2 custom-designed pages", "Fully responsive (mobile, tablet, desktop)", "Contact form & basic integrations", "Hosting & security setup"]
    }
  }, {
